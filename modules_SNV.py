...
class scTCHM(nn.Module):
    def __init__(self, bulk_num, batch_onehot_dim, driver_genes, x_dim, z_dim, h_dim, num_enc_z_layers, num_dec_z_layers, num_dec_p_layers, num_dec_b_layers, num_time_bins: int):
        super().__init__()
    ...
    def forward(self, x, batch_onehot, time=None, gene_name=None):
        ...
        return (z, qz, x_hat, p_bulk, bulk_hat, theta_x, theta_bulk, beta_z_all, gamma_z_dict)
